...
# Small mapping of ICAO -> IATA for common carriers. Extend as needed.
ICAO_TO_IATA = {
    ...
    "AAR": "OZ",   # Asiana (approx)
    "ETH": "ET",   # Ethiopian (approx)
    "KAL": "KE",   # Korean Air
    "SIA": "SQ",   # Singapore
    "NZ": "NZ",    # Air New Zealand common IATA
